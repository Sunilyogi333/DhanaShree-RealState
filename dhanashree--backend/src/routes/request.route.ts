...
router.get('/:id', authentication(ROLE.ADMIN), catchAsync(requestController.getOne.bind(requestController)))
router.patch('/:id', authentication(ROLE.ADMIN), catchAsync(requestController.update.bind(requestController)))
